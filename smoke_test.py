...
print("Running hybrid cascade grounding...")
...
if result.found:
    ...
    print("SUCCESS - saved test_detection.png")
    print("Open it to verify the red bounding box is on the Notepad icon.")
else:
    screenshot.save("debug_screenshot.png")
    print("ICON NOT FOUND - saved debug_screenshot.png for inspection")